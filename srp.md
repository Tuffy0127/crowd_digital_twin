...
上下楼之后看是否到达目标楼层更新路径,到了就去final goal,没到就去楼层的上楼点或者下楼点

goal_dis 在强制赋值之后出现了0的情况，已经解决



#### 太多agent涌入一个口导致agent错过下一目标点之后往回走

加入一个跟随周围agent数量变化的到达判断范围



#### agent在通过换层点的时候拥挤

已经通过的agent被判断为到了上层，不会对还在楼梯口的agent产生作用力，换层点的agent就会不考虑拥堵的越积越多



#### 到达判断

判断范围太大会导致agent行走被推入其他地方卡住，因为卡住的多了，重新搜索的点仍然被到达范围覆盖。

判断范围太小会导致agent被其他推离下一目标点而往回走



针对不同agent赋值，在卡住的情况下不断缩小到达范围（未做）
...
在垂直方向加入判断，如果搜索点到周围点之间存在障碍物，则不往这个点搜索
